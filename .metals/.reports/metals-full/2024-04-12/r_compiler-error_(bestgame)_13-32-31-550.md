file:///D:/bestgame/src/main/scala/App.scala
...
action parameters:
offset: 370
uri: file:///D:/bestgame/src/main/scala/App.scala
text:
```scala
import zio.http._
import zio._
...
object App {
    ...
    var socketToGame: scala.collection.mutable.Map[WebSocketChannel, String] = scala.collection.mutable.Map.empty
    ...
    def matchEvent(socket: WebSocketChannel, event: SocketEvent): Boolean =
    {
        event match
            ...
            case Collect(data)                  =>
              1+1
            case Unknown(data)                  =>
              1+1  // ну запихнуть обработку ошибки что чел с читами нет таких сообщений
        true
    }
}
