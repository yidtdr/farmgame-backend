file:///D:/bestgame/src/main/scala/gameClasses/Building.scala
...
action parameters:
offset: 1954
uri: file:///D:/bestgame/src/main/scala/gameClasses/Building.scala
text:
```scala
package gameClasses
...
object BuildingManager{
	...
	def getBuildingByName(building: String): Buildable =
	{
		...
		buildingType match
			case BuildingType.bakery => Bakery()
	...
	def collect(player: Player, building: Garden, data: String): Int =
	{
	...
	def collect(player: Player, building: Bakery, data: String): Int =
	{
